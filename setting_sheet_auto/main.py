...
"""
LEGACY: apply_modern_style (다크 테마)
- 과거 단독 실행(main.py 직접 실행)용 테마
- 현재는 app_shell 전역 라이트 테마 사용
- python -m machining_auto.app_shell 경로에서는 사용하지 않음
- 참조/복구 목적 보존
------------------------------------------------
def apply_modern_style(app: QApplication):
    ...
    # ─ 다크 팔레트 설정 ─
    palette = QPalette()
    palette.setColor(QPalette.Window, QColor(24, 27, 32))
    palette.setColor(QPalette.WindowText, QColor(230, 230, 230))
    palette.setColor(QPalette.Base, QColor(32, 35, 40))
    palette.setColor(QPalette.AlternateBase, QColor(32, 35, 40))
    palette.setColor(QPalette.ToolTipBase, QColor(255, 255, 255))
    palette.setColor(QPalette.ToolTipText, QColor(0, 0, 0))
    palette.setColor(QPalette.Text, QColor(230, 230, 230))
    palette.setColor(QPalette.Button, QColor(38, 41, 46))
    ...
    /* 추가 좌표 / 외곽 / Z 의 + 버튼 – 정사각형, 패딩 제거 */
    QPushButton#addCoordButton,
    QPushButton#addOuterButton,
